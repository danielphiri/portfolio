...
<h3 data-testid="page-title"> iOS Developer  </h3>
...
<h3 data-testid="page-title"> iOS Engineer  </h3>
[<h3 data-testid="page-title"> UC Berkeley  </h3>](https://octo.asuc.org/projects/berkeleymobile.html)

May 2018 - Dec 2018

Berkeley, CA

- Worked on the Berkeley Mobile application to deliver a seamless experience for UC Berkeley students
- Used Storyboards for the UI/UX, the MVC pattern, Xcode, Git, and more in the development lifecycle

Skills:  XCode · Swift · SwiftUI ᐧ iOS · Mobile Application Development · Software Testing · Software Development  ·  Cross-functional Collaborations · Documentation ᐧ CocoaPods
